...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.dir")+"/wallpaper";
        gc.setOutputDir(projectPath + "/src/main/java");
        gc.setAuthor("wallpaper");
        gc.setOpen(false);
        ...
        // ⼀、修改数据源
        dsc.setUrl("jdbc:mysql://localhost:3306/swpdb1?useUnicode=true&characterEncoding=UTF8&useSSL=false");
                // dsc.setSchemaName("public");
                dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("swpdb1_admin");
        dsc.setPassword("swpdb1_admin");
        ...
        //模块配置
        pc.setParent("com.example.wallpaper")
                .setEntity("entity")
                .setMapper("mapper")
                .setService("service")
